// Path: /src/components/setup/form-fields/EmployeeNameInput.tsx

import React from "react";
import { FormFieldProps } from "@/types/setup";

interface EmployeeNameInputProps extends FormFieldProps {}
  ...
  return (
    <div className="mb-6">
      ...
      <div className="flex items-center mb-3">
        ...
        <label className="text-gray-700 font-medium text-lg">ชื่อพนักงาน</label>
      </div>
